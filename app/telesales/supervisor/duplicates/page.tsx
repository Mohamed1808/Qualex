...
export default async function TSDuplicatesPage() {
  if (isPreviewMode()) {
    ...
    return (
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-sm text-[#6B7280] mt-0.5">{duplicates.length} duplicate entries detected</p>
        </div>
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-[#161616] border border-[#2a2a2a] rounded-xl p-4">
            <p className="text-xs text-[#6B7280] mb-1">Leads with Multiple Channels</p>
        ...
        <div>
          <h2 className="text-sm font-semibold text-white mb-3">Duplicate Entries</h2>
  ...
  // Also get original leads with channel history
    ...
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-[#6B7280] mt-0.5">
          {duplicates?.length ?? 0} duplicate entries detected
        </p>
      </div>
      ...
      {/* Original leads with multi-channel history */}
